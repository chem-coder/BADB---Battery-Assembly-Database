...
ledger-aware migrations such as `d033`, `d034`, `d035`, `d036`, and `d037`, because it verifies earlier migration
...
local `badb_app_v1` ledger reports `dima = 21` and `dalia = 25` after `d037`;
