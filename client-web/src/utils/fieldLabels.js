...
const LABELS_BY_ENTITY = {
  ...
  tape_step_coating: {
    ...
    gap_um:                      'Зазор, мкм',
    gap_um_side2:                'Зазор, мкм, сторона 2',
    coated_thickness_um:        'Толщина после нанесения, мкм (сторона 1)',
    coated_thickness_um_side2:  'Толщина после нанесения, мкм (сторона 2)',
