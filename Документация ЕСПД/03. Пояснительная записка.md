...
На текущий момент (06.05.2026, локальная БД `badb_app_v1`) база данных содержит:
...
| Количество миграций | 40 SQL-файлов в `migrations/`: базовый диапазон `001`–`020` плюс Dalia-миграции `d013`–`d031` |
